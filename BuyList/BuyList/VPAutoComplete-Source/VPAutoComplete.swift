...
class VPAutoComplete: UIView {
    ...
    public var viewColor: [UIColor] = [UIColor]()
    ...
    public convenience init(onTextField: UITextField , dataSource : [String], viewColor:[UIColor], onView: UIView, completionHandler: @escaping CompletionHandler){
        self.init()
...
extension VPAutoComplete : UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if is_filter {
            ...
            cell.viewCircle.backgroundColor = viewColor[indexPath.row]
        }else{
